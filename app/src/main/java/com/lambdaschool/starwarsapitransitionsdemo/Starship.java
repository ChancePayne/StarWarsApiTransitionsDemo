...
public class Starship extends SwApiObject{
    ...
    public String toString() {
        return String.format("The %s, model %s is manufactured by %s is %s meters in length built at a cost of %s credits.", this.name,model,manufacturer,length,costInCredits);
    }
}
